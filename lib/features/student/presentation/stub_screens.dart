...
class StudentPathwayStubScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => _StubScaffold(
        ...
        // this whole `extraActions` block (and the ones added for My
        // Tests/My Grades as they land) once the real Pathway hub list is
        // built — planning.md's Day 6 slot for Dashboard/Nav Grid is the
        // natural place to also replace this with the actual hub.
        extraActions: [
          OutlinedButton(
